...
<?php if ( have_posts() ) : ?>
	...
	elseif ( $title ) :
	?>
<?php if(!is_page( array('dealer-home-page','home'))) :?>		
<header class="impactfontgrey">
		<div class="container">
		
<h2 align="center" class="impactfontgrey"><?php echo $title; ?></h2>
<?php elseif(is_page('forgotpassword')) :?>
