...
== Changelog ==
= 14.12 =
* Enable unlimited optional link inclusion
* Made Bootstrap sidebar accordion-capable
* Added small stylesheet to handle new Bootstrap sidebar panel title links
* Updated Bootstrap to v 3.3.1 via CDN
* Included Bitcoin donation form
* Changed link of help forum to WordPress-hosted URL
* Re-incorporated login fail redirection
* Minor style cleanup
