...
<!-- show first name and last name if first name empty then show user name ----->
  ...
  <div class="box-view-img" align="center" id="userviewimg"> <a href="<?php echo $pageURL; ?><?php echo $sign; ?>id=<?php echo $userid; ?>">
  ...
  <div class="box-view-post" id="userviewpost"> Post <span class="box-view-post-num" id="userviewpostnum"> <a href="<?php echo $pageURL; ?><?php echo $sign; ?>id=<?php echo $userid; ?>"> <?php echo count_user_posts( $userid ); ?> </a> </span> </div>
</div>
