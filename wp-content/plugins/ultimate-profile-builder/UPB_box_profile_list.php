...
<div id="upb-form"> 
  ...
  <!-----------------------Start multi-profiles view header-------------------------->
  
  <div class="top-part">
    <div class="profile-user-name"> Members </div>
    <div class="member_search">
      <div style="float:left;" class="upb-search-from-left">
        <form action="" id="form1" name="form1" method="post">
          Search members
          <input type="text" id="search" name="search" />
        </form>
      </div>
      <div class="viewselector"> <a class="listview" onClick="listview()"></a> <a class="gridview" onClick="gridview()"></a> </div>
    </div>
  </div>
  <div id="main-upb-form"> 
    ...
    <div class="box-view-main " id="listusers"> </div>
