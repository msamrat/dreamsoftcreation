...
<div id="upb-form">
  <div class="main-edit-profile" align="center"> You are already registered. <br />
    <br />
...
if($row1->Type=='term_checkbox')
        ...
        <div class="lable-text">
          ...
          <div class="input-box <?php if($row1->Require==1)echo 'upb_termboxrequired';?>">
          <div class="term-box">
            <input type="checkbox" value="<?php echo 'yes';?>" id="<?php echo $key;?>" name="<?php echo $key;?>"  class="regular-text <?php echo $row1->Class;?>">
          
            <label for="<?php echo $key;?>"><?php echo $row1->Name;?><?php if($row1->Require==1)echo '<sup class="upb_estric">*</sup>';?></label></div>
