...
function Insert_Forgot_Password_Form($atts) {
	...
	$ReturnString .= "<div class='col-sm-12 forgot'>";
	$ReturnString .= "<div class='col-sm-3'> </div><div class='col-sm-6'>";	
	$ReturnString .= "<div id='ewd-feup-forgot-password-form-div' class='whiteroundshadowbox'>";
	...
	$ReturnString .= "<label for='Email' id='ewd-feup-reset-password' class='ewd-feup-field-label login-lale col-sm-2'>" . __('Email', 'EWD_FEUP') . ": </label>";
	$ReturnString .= "<input type='email' class='ewd-feup-text-input pure-input-1-3 login-lale col-sm-7' name='Email' value='' />";
	$ReturnString .= "</div>";
