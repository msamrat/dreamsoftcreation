			...
			<ul id="pagechecklist-most-recent" class="categorychecklist form-no-clear">
				<?php //$Products = $wpdb->get_results("SELECT Item_ID, Item_Name FROM $items_table_name ORDER BY Item_Views DESC"); 
					...
					foreach ($Users as $User) {
						echo "<li><label class='menu-item-title'><a href='/releuscars.com/wp-admin/admin.php?page=EWD-FEUP-options&Action=EWD_FEUP_User_Details&Selected=User&User_ID=" . $User->User_ID ."'> " . $User->Username . "</a></label></li>";
					}
				?>
			</ul>
		</div><!-- /.tabs-panel -->
