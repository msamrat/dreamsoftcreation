...
<!--[if (gte IE 9)|!(IE)]><!--><html <?php language_attributes(); ?>> <!--<![endif]-->
    <head>
        ...
        if (!empty($_COOKIE['color']))
            $cookiecolorscheme = $_COOKIE['color'];
        ?> 
        ...
        <?php
        $scheme = substr(get_option('wp_color_scheme'), 0);
...
//Check first that child theme is used or Parent theme and then that file exist or not in child theme if exist this file in child theme then include that otherwise used parent theme file
    ...
    <?php if (get_option('wp_site') == "Real Estate") { ?>
        <body <?php
        if (is_singular('listing') || is_page_template('contact.php')) {
            echo 'onload="initialize()"';
        }
        ?> id="<?php echo $home ?>" <?php body_class(); ?>>
        <?php } else { ?>
...
<?php if (get_option('wp_headersubmenu') == "show" || get_option('wp_showlogin') == "show") { ?>
                <div id="secondaryheadermenucontainer" class="sixteen columns outercontainer">
                    ...
                    <div class="container-head">
                        <div class="top-menu">
                            <img src="<?php bloginfo('template_url'); ?>/images/share_icon.png">
                        </div>
                        <?php
                        if (has_nav_menu('headersecondary')) {
...
<?php } ?>
            ...
            <div id="header" class="sixteen columns outercontainer">
                <div class="container-head">
                    ...
                    <div id="header-contact">
                        <img src="<?php bloginfo('template_url'); ?>/images/header_number.png">	
                    </div>
            ...
            <div id="menubar" class="sixteen columns outercontainer navbg">
                <div class="container-head">
                    <div class="menu-left">
                        <img src="<?php bloginfo('template_url'); ?>/images/auto_leases_sale.png">
                    </div>
                    <?php
            ...
            <div class="sixteen columns outercontainer">
                <div class="container-head">
                    <?php if (get_bloginfo('description') != '') { ?>
                        <p id="description"><?php bloginfo('description'); ?></p>
                     <?php } ?> 
