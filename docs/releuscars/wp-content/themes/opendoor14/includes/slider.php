					...
					<div class="slidertext">
						...
						<?php if ($slideshowtitle) {
							...
							the_title();
                                            ...
                                            <h2><img src="<?php bloginfo('template_url'); ?>/images/header_divider.png" width="490" height="2"></h2>
						...
						<?php } else { ?>
                                                        <div class="slider-buttons">
                                                            <div><a class="btn btn-colorscheme btn-large" href="<?php the_permalink() ?>"><img src="<?php bloginfo('template_url'); ?>/images/view_details_button.png" /></a></div>
                                                            <div><a class="btn btn-colorscheme btn-large" href="<?php the_permalink() ?>"><img src="<?php bloginfo('template_url'); ?>/images/buy_now_button.png" /></a></div>
                                                        </div>
